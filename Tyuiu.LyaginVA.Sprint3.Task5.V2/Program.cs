...
using Tyuiu.LyaginVA.Sprint3.Task5.V2.Lib;

namespace Tyuiu.LyaginVA.Sprint3.Task5.V2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Написать программу, которая вычисляет сумму сумм ряда по формуле, при   *");
